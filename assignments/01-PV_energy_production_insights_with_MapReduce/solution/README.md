...
```console
$ hadoop fs -mkdir ass1_input
```

Load the dataset file into the HDFS input folder:

```console
$ hadoop fs -put /home/vagrant/ITS-ICT_BigData/assignments/01-PV_energy_production_insights_with_MapReduce/solution/input/sunnyvale_pv_energy_production.csv ass1_input
```
...
```console
$ yarn jar /home/vagrant/ITS-ICT_BigData/assignments/01-PV_energy_production_insights_with_MapReduce/solution/target/pvenergy-mapreduce-1.0-SNAPSHOT.jar it.sunnyvale.hadoop.assignments.PVEnergyMapReduce ass1_input ass1_output 
...
```console
$ hadoop fs -cat ass1_input/part-r-00000
max     36492
```